...
## 2\. 文本样式与行内元素
  ...
  * ~~删除线~~ 使用 `~~`
  * `行内代码` 使用反引号
  * _下划线_ (部分解析器支持 HTML 标签)
  * 上标^示例^ 或 下标~示例~ (非标准，可用 HTML：X2, H2O)
...
## 10\. 链接与自动识别
  ...
  * 引用式链接：[一个示例](https://example.com/reference "引用链接说明")
  * 自动链接：https://github.com 和 email@example.com (部分解析器支持自动识别)

## 11\. HTML 标签支持

这段文字使用 HTML 标签显示为红色（如果解析器允许）。

**居中的粗体文本**

## 12\. 转义字符

*星号* _下划线_ {大括号} [方括号] #井号 >大于号 等。
...
!!!NOTE "提示一些用户应该了解的有用信息。"
  note

!!!TIP "提供能帮助用户更成功的可选信息或技巧。"
  tip

!!!IMPORTANT "标记对用户成功至关重要的关键信息。"
  imp

!!!WARNING "警示需要用户立即关注的紧急内容，因为存在潜在风险。"
  warn

!!!CAUTION "警告某项操作可能带来的负面后果。"
  caution

### 折叠块 (details)

点击展开详细内容 这是折叠区域内的内容。可以包含任意 Markdown 语法。 \- 列表项 \- **粗体** 
