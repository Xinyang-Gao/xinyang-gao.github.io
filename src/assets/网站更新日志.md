...
- **perf(ui-effects)**: 增强鼠标特效性能与自适应降级能力
      ...
      - 降低 CPU 占用，提升低端设备流畅度
- **refactor(ui-effects)**: 用 TypeScript 重构 ui-effects.ts
...
- **refactor(router, article)**: 用 TypeScript 重构 router.ts 、 article.ts
...
## v8.0.0 (2026-06-30)
- **refactor**: 重构网站结构
      - 详见`d2f8ded782c2dd196e7c54bb1f483b21b02eee8d`和`59966e81828fe19db1989ef3b30eb908319f20f4`
