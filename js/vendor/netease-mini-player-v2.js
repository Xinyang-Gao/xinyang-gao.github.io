...
class NeteaseMiniPlayer {
            ...
            if (this.playlist.length > 0) {
                ...
                if (this.config.autoplay && !this.config.embed) {
                    ...
                    try {
                        ...
                        console.log('[NMPv2]静音自动播放被拦截，转为交互后播放');
                    }
    ...
    async loadSongUrl(songId) {
        ...
        if (urlData && urlData.url) {
            ...
            console.log('[NMPv2]设置音频源:', httpsUrl);
...
console.log(["[NMPv2]基于 v2.1.0.2 改版", "NeteaseMiniPlayer V2 [NMPv2]", "原作者：BHCN STUDIO & 北海的佰川（ImBHCN[numakkiyu]）", "GitHub地址：https://github.com/numakkiyu/NeteaseMiniPlayer", "基于 Apache 2.0 开源协议发布"].join("\n"));
